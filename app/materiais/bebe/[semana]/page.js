...
import materiais from "../../../../data/materiais-bebe.json";
import UserMenu from "../../../components/UserMenu";
import MaterialCard from "../../../components/MaterialCard";

export default function MaterialBebe({ params }) {
    ...
    return (
      <div className="max-w-xl mx-auto p-6">
        ...
        <p className="text-gray-600 mb-6">
          Ainda não temos materiais para essa semana.
        </p>

        <button
          onClick={() => router.push(`/semanas/bebe/${semana}`)}
